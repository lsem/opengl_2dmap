...
namespace {
p32 from_v2(v2 v) { return p32{static_cast<uint32_t>(v.x), static_cast<uint32_t>(v.y)}; }
} // namespace
...
struct DebugCtx {
    ...
    void add_line(v2 a, v2 b, Color c) { this->lines.emplace_back(from_v2(a), from_v2(b), c); }
