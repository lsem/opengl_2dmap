...
enum ImGuiItemFlags_ {
    ...
    ImGuiItemFlags_Disabled =
        1 << 2, // false     // Disable interactions but doesn't affect visuals. See
                // PushDisabled()/PushDisabled(). See github.com/ocornut/imgui/issues/211
...
enum ImGuiButtonFlagsPrivate_ {
    ...
    // PushDisabled() or ImGuiItemFlags_Disabled
...
enum ImGuiSelectableFlagsPrivate_ {
    ...
    ImGuiSelectableFlags_DrawHoveredWhenHeld =
        1 << 25, // Always show active when held, even is not hovered. This concept could probably
...
struct ImGuiContext {
    ...
    ImGuiNavItemData NavMoveResultLocalVisibleSet; // Best move request candidate within NavWindow
...
//  focused = FocusableItemRegister(...)' (New) IMGUI_VERSION_NUM >= 18209: using 'ItemAdd(...,
//  ImGuiItemAddFlags_Focusable)'  and 'bool focused = (GetItemStatusFlags() &
...
IMGUI_API bool ScrollbarEx(const ImRect &bb, ImGuiID id, ImGuiAxis axis, float *p_scroll_v,
                           float avail_v, float contents_v, ImDrawFlags flags);
