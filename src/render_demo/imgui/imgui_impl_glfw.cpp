...
//  2021-07-29: *BREAKING CHANGE*: Inputs: MousePos is correctly reported when the host platform
//  window is hovered but not focused (using glfwSetCursorEnterCallback). If you called
//  ImGui_ImplGlfw_InitXXX() with install_callbacks = false, you MUST install the
//  glfwSetCursorEnterCallback() callback and the forward to the backend via
