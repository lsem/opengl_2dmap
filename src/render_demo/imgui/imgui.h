...
IMGUI_API bool IsItemClicked(
    ImGuiMouseButton mouse_button =
        0); // is the last item hovered and mouse clicked on? (**)  == IsMouseClicked(mouse_button)
            // && IsItemHovered()Important. (**) this it NOT equivalent to the behavior of e.g.
...
CalcListClipping(int items_count, float items_height, int *out_items_display_start,
                 int *out_items_display_end); // calculate coarse clipping for large list of evenly
                                              // sized items. Prefer using the ImGuiListClipper
...
//ImGuiTableFlags_ColumnsWidthStretch = ImGuiTableFlags_SizingStretchSame   // WIP Tables 2020/12 ,
//ImGuiTableFlags_SizingPolicyFixed = ImGuiTableFlags_SizingFixedFit,
//ImGuiTableFlags_SizingPolicyStretch = ImGuiTableFlags_SizingStretchSame   // WIP Tables 2021/01
#endif
};
...
struct ImFontAtlas {
    ...
    } // Bit ambiguous: used to detect when user didn't built texture but effectively we should
...
struct ImFont {
    ...
    ImWchar DotChar; // 2     // out // = '.'      // Character used for ellipsis rendering (if a
                     // single '...' character isn't found)
...
// SetScrollHereY(ratio); }                                  // OBSOLETED in 1.66 (from Nov 2018)
// static inline bool  IsItemDeactivatedAfterChange()        { return IsItemDeactivatedAfterEdit();
// }                    // OBSOLETED in 1.63 (from Aug 2018) static inline bool  IsAnyWindowFocused()
// { return IsWindowFocused(ImGuiFocusedFlags_AnyWindow); }    // OBSOLETED in 1.60 (from Apr 2018)
// static inline bool  IsAnyWindowHovered()                  { return
// IsWindowHovered(ImGuiHoveredFlags_AnyWindow); }    // OBSOLETED in 1.60 (between Dec 2017 and Apr
// 2018) static inline void  ShowTestWindow()                      { return ShowDemoWindow(); } //
// OBSOLETED in 1.53 (between Oct 2017 and Dec 2017) static inline bool  IsRootWindowFocused() {
// return IsWindowFocused(ImGuiFocusedFlags_RootWindow); }   // OBSOLETED in 1.53 (between Oct 2017
...
// SetNextWindowContentSize(ImVec2(w, 0.0f)); }              // OBSOLETED in 1.53 (between Oct 2017
// and Dec 2017) static inline float GetItemsLineHeightWithSpacing()       { return
// GetFrameHeightWithSpacing(); }                     // OBSOLETED in 1.53 (between Oct 2017 and Dec
// 2017)
} // namespace ImGui
