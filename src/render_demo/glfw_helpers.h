...
struct GLFWMouseController {
    ...
    using mouse_button_cb_t = std::function<void(GLFWwindow *wnd, int btn, int act, int mods)>;
    using mouse_scroll_cb_t = std::function<void(GLFWwindow *wnd, double xoffset, double yoffset)>;
    using mouse_move_cb_t = std::function<void(GLFWwindow *wnd, double xpos, double ypos)>;
    ...
    static void mouse_scroll_callback(GLFWwindow *wnd, double xoffset, double yoffset) {
        if (scroll_cb) {
            scroll_cb(wnd, xoffset, yoffset);
        }
    }

    static void mouse_button_callback(GLFWwindow *wnd, int btn, int act, int mods) {
        if (btn_cb) {
